...
switch (argc[0]) {
    ...
    case 'getaddressbalance':
        User.GetWalletAddressBalance(argc[1], argc[2]);
        break;
    case 'gettransactionlistbyaddress':
        User.GetTransactionListByAddress(argc[1], argc[2], parseInt(argc[3]), parseInt(argc[4]));
        break;
